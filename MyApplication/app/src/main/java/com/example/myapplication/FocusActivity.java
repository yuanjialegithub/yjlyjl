    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mfbt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //启动和停止MusicService
                final Intent i=new Intent(FocusActivity.this,MusicService.class);
...
// TODO 自动生成的方法存根
                if(!PAUSE)//暂停计时
                {
                    btnPC.setText("继续");
//从开始计时计时器运行的时间差。。。。。关键
                    FocusActivity.this.rangeTime=SystemClock.elapsedRealtime()-chronometer.getBase();
...
// 给用户提示
    ...
    public void onclickstop(View view) {//弹出对话框
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(FocusActivity.this, "已暂停", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
        ...
        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Toast.makeText(FocusActivity.this, "取消暂停", Toast.LENGTH_SHORT).show();
                arg0.dismiss();
            }
        });
    ...
    public void onclickexit(View view) {//弹出对话框
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog1, int which1) {
                Toast.makeText(FocusActivity.this, "退出", Toast.LENGTH_SHORT).show();
                dialog1.dismiss();
        ...
        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
            ...
            @Override
            public void onClick(DialogInterface arg0, int arg1) {
                Toast.makeText(FocusActivity.this, "取消退出", Toast.LENGTH_SHORT).show();
                arg0.dismiss();
            }
        });
        AlertDialog a = builder.create();
